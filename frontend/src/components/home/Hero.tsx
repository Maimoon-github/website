...
import { Sparkles, ArrowRight, Bot, Cpu, Shield, Rocket, ExternalLink, Github } from 'lucide-react';
    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <span className="text-sm font-medium tracking-wide uppercase">The Future of Agentic AI Engineering</span>
        </motion.div>
        ...
        >
          Architecting <span className="text-gradient">Autonomous</span> Intelligence
        </motion.h1>
        ...
        >
          A comprehensive knowledge hub and portfolio dedicated to production-grade Agentic AI systems. From cognitive architectures to multi-agent swarms.
        </motion.p>
        ...
        >
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="font-mono text-sm tracking-widest">AGENTIC</span>
          </div>
          <div className="flex items-center justify-center gap-2">
            <Cpu className="w-6 h-6" />
            <span className="font-mono text-sm tracking-widest">COGNITIVE</span>
          </div>
          <div className="flex items-center justify-center gap-2">
            <Shield className="w-6 h-6" />
            <span className="font-mono text-sm tracking-widest">GOVERNED</span>
          </div>
          <div className="flex items-center justify-center gap-2">
            <Rocket className="w-6 h-6" />
            <span className="font-mono text-sm tracking-widest">PRODUCTION</span>
          </div>
        </motion.div>
      </div>
