      ...
      <div className="max-w-[1440px] mx-auto px-10 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.length > 0 ? services.map((service) => (
            <div key={service.id} className="bg-[var(--surface)]/30 border border-[var(--surface)] rounded-2xl p-8 hover:border-[var(--accent)]/50 hover:bg-[var(--surface)]/50 transition-all group relative overflow-hidden h-full flex flex-col">
              ...
              <div className="relative z-10 flex-grow flex flex-col">
                ...
                {service.price_starting_at && (
                  <div className="text-[var(--accent)] font-mono text-xs tracking-widest uppercase mt-auto">
