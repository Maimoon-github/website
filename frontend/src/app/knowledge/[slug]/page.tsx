      ...
      <header className="mb-16">
        <div className="flex items-center gap-6 mb-8">
          ...
          <div>
            ...
            <h1 className="text-4xl md:text-7xl font-black tracking-tighter uppercase text-white">{domain.name}</h1>
          </div>
        </div>
      ...
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           ...
           <div className="p-10 glass border-l-4 border-l-accent-light bg-accent-light/5">
              <h3 className="font-bold text-lg mb-4 uppercase tracking-tighter text-white">Strategic Impact</h3>
